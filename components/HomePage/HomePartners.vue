<template>
  <div class="wrap">
    <div class="container">
      <div class="header">
        <h4 class="title">
          Мы воплощаем в жизнь наших клиентов новые технологии
        </h4>
        <div class="home__button">
          <button class="home__btn parallax-button">
            <svg
              class="home__btn-svg"
              width="70"
              height="44"
            ...
            >
              <path
                class="path"
                d="M68.8805 3.11354L0.426346 42.6356M68.8805 3.11354C58.3831 12.5969 53.0198 19.1162 53.0907 35.0478M68.8805 3.11354C55.419 7.46286 47.0915 8.84803 33.3297 0.820759"
                stroke="white"
                stroke-width="1.4"
              />
            </svg>
            <div class="rotate__txt">
              <svg
                class="transform__txt"
                xmlns="http://www.w3.org/2000/svg"
                width="160"
                height="160"
                fill="none"
...
.home__btn:hover .home__btn-svg {
  transform: rotate(30deg);
}

.home__btn:hover path {
...
.transform__txt {
  ...
  animation: rotate_txt 6s infinite;
